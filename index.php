...
<header class="header">
   ...
   <a href="#home" class="logo"><img src="" alt=""></a>
...
<section class="home" id="home">
   ...
   <div class="content">
      <img data-aos="fade-up" data-aos-delay="150" src="images/produk-6.png" alt="">
      <h3 data-aos="fade-up" data-aos-delay="300">Beface</h3>
      <p data-aos="fade-up" data-aos-delay="450">Skincare Dengan Kualitas Premium</p>
      <a data-aos="fade-up" data-aos-delay="600" href="#menu" class="btn">MENU</a>
   </div>
   ...
   <div class="box-container">
      ...
      <div class="box" data-aos="fade-up" data-aos-delay="150">
         ...
         <div class="content">
            ...
            <h3>Wardah C-Defense DD Cream/h3>
      ...
      <div class="box" data-aos="fade-up" data-aos-delay="300">
         ...
         <div class="content">
            ...
            <h3>Wardah C-Defense Waterclay Mask 30gr</h3>
      ...
      <div class="box" data-aos="fade-up" data-aos-delay="450">
         ...
         <div class="content">
            ...
            <h3>Wardah Colorfit Matte Foundation</h3>
            <div class="price">Rp 60,750</div>
            <a href="#" class="btn">add to cart</a>
         </div>
      </div>
      ...
      <div class="box" data-aos="fade-up" data-aos-delay="750">
         ...
         <div class="content">
            ...
            <h3>Wardah Colorfit Last All Day Lip Paint</h3>
            <div class="price">
               Rp 55,800</div>
            <a href="#" class="btn">add to cart</a>
         </div>
      ...
      <div class="box" data-aos="fade-up" data-aos-delay="900">
         ...
         <div class="content">
            ...
            <h3>Wardah Colorfit Velvet Powder Foundation</h3>
            <div class="price">Rp 58,950</div>
            <a href="#" class="btn">add to cart</a>
         </div>
      </div>
...
<section class="about" id="about">
   ...
   <div class="content" data-aos="fade-left" data-aos-delay="300">
      ...
      <div class="icons">
         ...
         <h3> <i class="fas fa-check"></i> natural  </h3>
...
<section class="reviews" id="reviews">
   ...
   <div class="box-container">
      ...
      <div class="box" data-aos="fade-up" data-aos-delay="300">
         <img src="images/pic-2.png" alt="">Lorem
         <h3>POSWAN NASI UDUK</h3>
         <p> Mau saya kokop?</p>
         <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
...
<section class="contact" id="contact">
   ...
   <div class="row">
      ...
      <iframe data-aos="fade-up" data-aos-delay="150" class="map" src="https://maps.app.goo.gl/WG9fV7TQzHUdzcyN6" allowfullscreen="" loading="lazy"></iframe>
   ...
   <div class="box-container">
      ...
      <div class="box" data-aos="fade-up" data-aos-delay="150">
         <div class="image">
            <img src="images/produk-5.png" alt="">
            <div class="icons">
               <a href="#"> <i class="fas fa-calendar"></i> 2023 </a>
               <a href="#"> <i class="fas fa-user"></i> By Yoga</a>
            </div>
         </div>
         <div class="content">
            <h3>New Produk</h3>
...
<section class="footer">
   ...
   <p class="credit"> created by <span><a href="https://www.instagram.com/ardksfs_/">Yoga</a></span> | all rights reserved! </p><br>
